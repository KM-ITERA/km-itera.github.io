    ...
    <div className="App flex items-center flex-col my-5">
        ...
        <div className="py-2 w-4/5 justify-center flex">
            <a href="https://twitter.com/km_itera" target="_blank" className="w-3/5 max-[450px]:w-full justify-center flex" rel="noreferrer">
                <button className="w-full bg-transparent hover:bg-goldish hover:shadow-slate-100 hover:shadow-md hover:-translate-y-2 text-goldish font-semibold hover:text-slate-900 py-2 px-4 border border-goldish hover:border-transparent rounded">
        ...
        <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-goldish text-gray-900" data-inactive-classes="text-goldish" className="w-4/5 min-[450px]:w-2/4">
            ...
            <div id="accordion-flush-body-1" className="hidden" aria-labelledby="accordion-flush-heading-1">
                <div className="py-5 border-b border-goldish">
                    <p className="mb-2 text-gray-300 selection:bg-goldish selection:text-gray-900">
                    ...
                    <p className="text-gray-300 flex flex-col">
                        Lakukan pendaftaran pada link berikut
                        <a href="#" className="text-blue-600 dark:text-blue-500 hover:underline w-3/12">
                            <button className="w-full bg-transparent hover:bg-goldish text-goldish font-semibold hover:text-slate-900 mt-2 py-2 px-4 border border-goldish hover:border-transparent rounded">
                                Daftar
                            </button>
                        </a> 
                    </p>
            ...
            <h2 id="accordion-flush-heading-3">
                <button type="button" className="flex items-center justify-between w-full py-5 font-medium text-left text-gray-400 border-b border-goldish" data-inactive-classes="text-gray-600" data-accordion-target="#accordion-flush-body-3" aria-expanded="false" aria-controls="accordion-flush-body-2">
                    <span className="px-3">
            ...
            <div id="accordion-flush-body-3" className="hidden" aria-labelledby="accordion-flush-heading-3">
                <div className="py-5 border-b border-goldish">
                    <p className="mb-2 text-gray-400 selection:bg-goldish selection:text-gray-900">
                        Pemilihan Duta ITERA yang diinisiasi oleh Kementerian Bidang Seni dan Kebudayaan Keluarga Mahasiswa (KM) ITERA, menjadi ajang unjuk bakat dan kemampuan mahasiswa ITERA. Mahasiswa tidak hanya berkompetisi dalam kemampuan akademik, tetapi juga non akademik melalui berbagai bakat yang dimiliki.
                    </p>
                    <p className="text-gray-400 flex flex-col">
                        Lakukan pendaftaran pada link berikut
                        <a href="#" className="text-blue-600 dark:text-blue-500 hover:underline w-3/12">
                            <button disabled className="disabled:opacity-50 w-full bg-transparent hover:bg-goldish text-goldish font-semibold hover:text-slate-900 mt-2 py-2 px-4 border border-goldish hover:border-transparent rounded">
                                Daftar
                            </button>
                        </a> 
                    </p>
            ...
            <h2 id="accordion-flush-heading-2">
                <button type="button" className="flex items-center justify-between w-full py-5 font-medium text-left text-gray-400 border-b border-goldish" data-inactive-classes="text-gray-600" data-accordion-target="#accordion-flush-body-2" aria-expanded="false" aria-controls="accordion-flush-body-2">
                    <span className="px-3">
                        Open Recruitment Ketua Pelaksana Icositer 2023 <p className="text-goldish">COMING SOON...</p>
                    </span>
                    <svg data-accordion-icon className="w-6 h-6 shrink-0 mx-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </button>
            </h2>
